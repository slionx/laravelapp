        ...
        @include('admin.layouts.theme-panel')
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="#">{{ trans('common.permission') }}</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span>{{ trans('common.create') }}{{ trans('common.permission') }}</span>
                    </li>
                </ul>
                        ...
                        <div class="portlet-body">
                            <div class="table-toolbar">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            <a href="{{ route('permission.create') }}" id="sample_editable_1_new" class="btn sbold green"> {{ trans('common.create') }}{{ trans('common.permission') }}
