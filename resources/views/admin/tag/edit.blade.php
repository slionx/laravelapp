                    ...
                    <div class="portlet light form-fit bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-dark bold uppercase">{{ trans('common.edit') }}{{ trans('common.tag') }}</span>
                            </div>
                            <div class="actions">
                        ...
                        <div class="portlet-body form">
                            <form action="{{ route('tag.update',$id) }}" method="post" class="form-horizontal form-bordered">
                                {{ csrf_field() }}
                                {{method_field('PUT')}}
                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-icon right">
                                            ...
                                            <input type="text" name="name" value="{{ isset($tag) ? $tag->name : old('name') }}" class="form-control" id="name" placeholder="标签名称">
