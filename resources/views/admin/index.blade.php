                    ...
                    <div class="portlet-body">
                        ...
                        <div class="table-scrollable table-scrollable-borderless">
                            <table class="table table-hover table-light">
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic rounded" src="{{ asset('pages/media/users/avatar4.jpg') }}"> </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic rounded" src="{{ asset('pages/media/users/avatar5.jpg') }}"> </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic rounded" src="{{ asset('pages/media/users/avatar6.jpg') }}"> </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic rounded" src="{{ asset('pages/media/users/avatar7.jpg') }}"> </td>
                                    <td>
                        ...
                        <div class="scroller" style="height: 338px;" data-always-visible="1" data-rail-visible1="0" data-handle-color="#D7DCE2">
                            <div class="general-item-list">
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar4.jpg') }}">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar3.jpg') }}">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar6.jpg') }}">
                                            <a href="" class="item-name primary-link">Nick Larson</a>
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar7.jpg') }}">
                                            <a href="" class="item-name primary-link">Nick Larson</a>
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar9.jpg') }}">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar8.jpg') }}">
                                ...
                                <div class="item">
                                    <div class="item-head">
                                        <div class="item-details">
                                            <img class="item-pic rounded" src="{{ asset('pages/media/users/avatar2.jpg') }}">
                ...
                <div class="portlet light portlet-fit ">
                    ...
                    <div class="portlet-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mt-widget-2">
                                    <div class="mt-head" style="background-image: url('{{ asset('pages/img/background/4..jpg') }}');">
                                        <div class="mt-head-label">
