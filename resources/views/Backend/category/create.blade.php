...
@section('content')
    ...
    <div class="m-content">
        ...
        <div class="m-portlet">
                ...
                <div class="m-portlet__head-caption">
                    <div class="m-portlet__head-title">
                        <h3 class="m-portlet__head-text">
                            {{ trans('common.create') }}{{ trans('common.category') }}
                        </h3>
                    </div>
                </div>
            ...
            <!--begin::Form-->
            <form class="m-form m-form--fit m-form--label-align-right" novalidate="novalidate" method="post" action="{{ route('category.store') }}">
                {{ csrf_field() }}
