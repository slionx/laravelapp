...
class RoleController extends Controller
{
    ...
    public function create(  )
    {
        ...
        return view( 'Backend.role.create',compact('permissionArray','role_permissionArray') );
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($result ) {
            ...
            return Redirect()->route('role.index')->with( 'success', '角色 ' . $request->name .' 创建成功' );
        } else {
            return Redirect()->back()->withInput($request->all())->with( 'error','角色 ' . $request->name . ' 创建失败' );
        }
    }
    ...
    public function edit($id)
    {
        ...
        return view( 'Backend.role.edit' ,compact('role_permissionArray','permissionArray','role'));
    }
    ...
    public function update(Request $request ,$id)
    {
        try {
            ...
            if($bool){
                ...
                return redirect()->back()->withInput($request->all())->with('error','更新失败！');
            }

        } catch ( Exception $e ) {
            return redirect()->back()->withInput($request->all())->with('error','更新失败！'. $e->getMessage());
        }
    }
